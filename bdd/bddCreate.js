...
tab.push("INSERT INTO `user` (`idUtilisateur`, `nomUtilisateur`) VALUES(1, 'rogers'),(2, 'david'),(3, 'maria'),(4, 'morris'),(5, 'daniel'),(6, 'sanders'),(7, 'mark'),(8, 'morgan'),(9, 'paul');")
tab.push("INSERT INTO `projet` (`idProjet`, `nomProjet`, `description`) VALUES(1, 'Pont de Lyon', 'Construction du pont'),(2, 'Reconstruction batiment', 'Reconstruction du batiment'),(3, 'Fete des lumieres', 'Organisation de la fete des lumieres');")
